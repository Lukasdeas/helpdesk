...
import logoImage from "@assets/logoDoctum_1761734628149.png";
  ...
  const handleTechLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // SEGURANÇA: Não armazenar dados no localStorage
        // Sessão é gerenciada via httpOnly cookies no servidor
        ...
        <CardContent className="p-8">
          <div className="text-center mb-8">
            <div className="mb-4 flex justify-center">
              <img src={logoImage} alt="Help Doctum Logo" className="h-24 w-auto object-contain" />
            </div>
      ...
      <Dialog open={showTechLogin} onOpenChange={setShowTechLogin}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Insira suas credenciais para acessar o painel técnico ou administrativo.
            </DialogDescription>
          </DialogHeader>
